...
public class NewSceneCreator : EditorWindow
{
    ...
    [MenuItem("Template Scene/Create New Scene...", priority = 100)]
    static void Init()
    {
    ...
    protected void CreateScene()
    {
        ...
        if (result.Length > 0)
        {
            string originalScenePath = AssetDatabase.GUIDToAssetPath(result[0]);

            string newScenePath = "Assets/RPGAE/Scenes/Gameplay/" + m_NewSceneName + ".unity";
        ...
        else
        {
            ...
            EditorUtility.DisplayDialog("Error",
                "The scene _TemplateScene was not found in RPGAE/Scenes folder. This scene is required by the New Scene Creator.",
                "OK");
        }
    }
